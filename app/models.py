...
from sqlalchemy import Boolean, Date, DateTime, Enum as SAEnum, Float, ForeignKey, Integer, String, Text, UniqueConstraint, func
...
class Task(Base):
    ...
    danger_flag: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default="false")
